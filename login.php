...
<head>
	...
	define('bankName', 'Sparks Project : MCB Bank'); // Remove the third argument
...
<body style="background: url(images/hello.jpg);background-size: 100%">
    <h1 class="alert alert-success rounded-0"><?php echo bankName; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by: Pavitra & Sushma</kbd></small></h1>
    <br>
    <?php echo $error ?>
    <br>
